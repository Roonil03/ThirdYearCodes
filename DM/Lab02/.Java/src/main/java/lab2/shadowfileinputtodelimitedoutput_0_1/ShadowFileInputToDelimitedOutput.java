...
package lab2.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_LAB2_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_LAB2_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LAB2_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_LAB2_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_LAB2_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_LAB2_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LAB2_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_LAB2_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LAB2_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_LAB2_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LAB2_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/TimeToShine/TalenDLabPractice/LAB2/temp/preview/student.csv")).getAbsolutePath()
								.replace("\\", "/");
				...
				try {
					...
					Object filename_tFileInputDelimited = "C:/TimeToShine/TalenDLabPractice/Dataset/student.csv";
					...
					try {
						fid_tFileInputDelimited = new org.talend.fileprocess.FileInputDelimited(
								...
								0, 0, limit_tFileInputDelimited, -1, false);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"lab2/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 53024 characters generated by Talend Open Studio for Data Integration on the
 * January 29, 2026, 8:29:37 AM IST
 ************************************************************************************************/