...
package lab01_R03.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_LAB01_R03_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_LAB01_R03_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LAB01_R03_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_LAB01_R03_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_LAB01_R03_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_LAB01_R03_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LAB01_R03_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_LAB01_R03_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LAB01_R03_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_LAB01_R03_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LAB01_R03_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"D:/R03_DM/Lab01/LAB01_R03/temp/preview/Data.csv")).getAbsolutePath().replace("\\",
								"/");
				...
				String[] headColutFileOutputDelimited = new String[4];
				...
				try {
					...
					Object filename_tFileInputDelimited = "D:/R03_DM/Lab01/Data.csv";
					...
					try {
						fid_tFileInputDelimited = new org.talend.fileprocess.FileInputDelimited(
								...
								limit_tFileInputDelimited, -1, false);
...
// Start of branch "Row"
						if (Row != null) {
							...
							String[] rowtFileOutputDelimited = new String[4];
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"lab01_R03/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 47036 characters generated by Talend Open Studio for Data Integration on the
 * 9 January 2026, 3:19:07 pm IST
 ************************************************************************************************/